...
const skills = [
  ...
  },
  {
    ...
    description: '实时比对 Polymarket、Kalshi、Manifold 等多平台价格差异，发现套利机会并计算利润空间。',
    color: '#00d4aa',
  ...
  },
  {
    ...
    description: '实时抓取路透社、彭博、推特等媒体信息流，自动生成情感评分并触发相关市场交易信号。',
    color: '#4f88ff',
  ...
  },
  {
    ...
    description: '根据用户风险偏好和历史交易行为，定制化推送高置信度市场信号，支持多渠道实时通知。',
    color: '#06b6d4',
